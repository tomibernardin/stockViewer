...
export default function Header({ ticker, setTicker, lang, setLang, page, setPage, tr }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#08090d] border-b border-[#1e2130]">
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2 gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <nav className="flex rounded overflow-hidden border border-[#1e2130] text-xs font-mono">
            <button
              onClick={() => setPage(1)}
              /* min-h-[44px] para área de toque mínima táctil (WCAG) */
      ...
      {/* Fila 2: selector de ticker — ancho completo en mobile */}
      <div className="px-4 pb-3">
        <select
          ...
          /* font-size 16px — previene zoom automático en iOS al hacer focus */
          style={{ fontSize: '16px' }}
        >
          {grouped.map(g => (
