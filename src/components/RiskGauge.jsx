export default function RiskGauge({ score, tr }) {
  ...
  function arc(start, end, color, strokeW = 8) {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <svg viewBox="0 0 200 160" className="w-48 h-36">
        ...
        <text x={cx} y={cy + 28} textAnchor="middle" fill="white"
          className="font-mono" style={{ fontSize: 28, fontWeight: 700, fontFamily: 'JetBrains Mono' }}>
          {clamped}
        </text>
      </svg>
